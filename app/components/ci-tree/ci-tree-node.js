...
import layout from '../../templates/components/ci-tree/ci-tree-node';
...
export default Ember.Component.extend({
  ...
  styleClasses: (function() {
    var _ref;
    return (_ref = defaultConfig.nodeClasses) != null ? _ref.join(" ") : void 0;
  }).property(),
  expandedClasses: (function() {
    var _ref, _ref1;
    if (this.get('expanded')) {
      return (_ref = defaultConfig.nodeOpenClasses) != null ? _ref.join(" ") : void 0;
    } else {
      return (_ref1 = defaultConfig.nodeCloseClasses) != null ? _ref1.join(" ") : void 0;
    }
  }).property('expanded', 'leaf', 'loading'),
  nodeSelectedClasses: (function() {
    var _ref;
    if (this.get('isSelected')) {
      return (_ref = defaultConfig.nodeSelectedClasses) != null ? _ref.join(" ") : void 0;
    } else {
      return null;
    }
  }).property('isSelected'),
  ...
  iconClass: (function() {
    ...
    if (this.get('async')) {
      ...
      if (this.get('leaf')) {
        icons = icons.concat(defaultConfig.nodeLeafIconClasses);
      } else {
        icons = this.get('expanded') ? icons.concat(this.iconFromModelOrDefault('nodeOpenIconClasses')) : icons.concat(this.iconFromModelOrDefault('nodeCloseIconClasses'));
      }
    }
  ...
  leafClasses: (function() {
    var _ref;
    if (this.get('leaf')) {
      return (_ref = defaultConfig.nodeLeafClasses) != null ? _ref.join(" ") : void 0;
    }
  }).property('leaf'),
  ...
  iconFromModelOrDefault: function(iconConfigName) {
    ...
    if (nodeType && iconsPerType && iconsPerType[nodeType] && iconsPerType[nodeType][iconConfigName]) {
      ...
      return defaultConfig[iconConfigName];
    }
  },
  actions: {
